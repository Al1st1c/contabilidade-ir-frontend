...
<template>
  <div class="relative z-50 w-full flex items-center justify-between h-14 mb-6">
    <div class="flex items-center gap-x-5 justify-center">
      <button type="button" class="flex xl:hidden items-center" @click="emits('toggleMobileNav')">
    ...
    <div class="flex items-center justify-end gap-x-3">
      ...
      >
        ...
        <div class="flex gap-1">
          ...
          <BaseKbd size="sm" variant="default" class="!px-2 !font-semibold h-6!">
            K
          </BaseKbd>
        </div>
      </div>
        ...
        <template #button>
          <button type="button">
            <BaseChip size="sm" color="custom" :offset="3" class="text-success-500">
              <img src="/img/avatars/10.svg" class="size-8 rounded-full object-cover">
            </BaseChip>
          </button>
        </template>
