    ...
    <DialogPortal>
      ...
      <DialogContent
        ...
        <div
          ...
          <BaseButton v-if="currentStep > 0" variant="muted" rounded="lg" size="sm" class="px-5 h-9 font-bold"
            @click="prevStep">
          ...
          <div class="flex items-center gap-3">
            <button v-if="currentStep > 0 && currentStep < steps.length - 1"
              class="text-[10px] font-bold text-muted-400 hover:text-muted-600 px-2 uppercase tracking-wider"
              @click="nextStep">
              Pular
            </button>
            <BaseButton variant="primary" :loading="isLoading" rounded="lg" size="sm"
              class="w-36 h-9 font-bold shadow-lg shadow-primary-500/10" @click="nextStep">
