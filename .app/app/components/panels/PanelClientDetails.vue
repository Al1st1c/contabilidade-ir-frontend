    ...
    <div class="nui-slimscroll h-[calc(100dvh-80px)] overflow-y-auto p-8">
      ...
      <div v-else-if="clientData" class="space-y-10">
        ...
        <div class="flex items-center gap-4">
          <BaseAvatar
            size="xl" :text="(clientData?.name || '').charAt(0).toUpperCase()"
        ...
        <div class="grid grid-cols-2 gap-4">
          <BaseCard
            v-if="clientData.phone" rounded="lg"
        ...
        <div>
          ...
          <div v-if="clientData.taxDeclarations?.length > 0" class="space-y-3">
            <div
              v-for="dec in clientData.taxDeclarations" :key="dec.id"
          ...
          >
            ...
            <BaseButton
              size="sm" variant="primary" class="mt-4"
