...
async function fetchClientDetails() {
  ...
  try {
    ...
    clientData.value = data?.data ?? data
  }
  catch (error) {
      ...
      <div v-else-if="clientData" class="space-y-10">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <BaseParagraph size="xs" class="text-muted-400 font-mono mt-1">
              {{ clientData.cpf }}
            </BaseParagraph>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <BaseCard v-if="clientData.phone" rounded="lg"
            ...
            <BaseParagraph size="xs" class="text-muted-400 uppercase tracking-tighter mb-1 font-medium">
              Telefone
            </BaseParagraph>
        ...
        <div>
          <div class="flex items-center justify-between mb-4">
            ...
            <BaseTag size="sm" variant="muted" rounded="full">
              {{ clientData.taxDeclarations?.length || 0 }} anos
            </BaseTag>
          </div>
        ...
        <div class="space-y-4">
          ...
          <div
            class="p-4 bg-primary-50 dark:bg-primary-900/10 border border-primary-100 dark:border-primary-900/30 rounded-xl">
            <BaseParagraph size="sm" class="text-primary-800 dark:text-primary-200 italic">
