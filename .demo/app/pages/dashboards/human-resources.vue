        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-col items-center justify-between gap-6 sm:flex-row mb-6">
            ...
            <div class="flex gap-2 sm:justify-end">
              <BaseButton rounded="md" size="sm" :variant="activeSetting === 'all' ? 'primary' : 'default'"
                @click="activeSetting = 'all'">
                All
              </BaseButton>
              <BaseButton rounded="md" size="sm" :variant="activeSetting === 'candidates' ? 'primary' : 'default'"
                @click="activeSetting = 'candidates'">
                Candidates
              </BaseButton>
              <BaseButton rounded="md" size="sm" :variant="activeSetting === 'companies' ? 'primary' : 'default'"
          ...
          <div class="mt-6 grid grid-cols-12 gap-x-6 gap-y-12">
            ...
            <div class="col-span-12 sm:col-span-5">
              <div class="flex h-full max-w-[240px] flex-col justify-center gap-2">
                <BaseHeading as="h3" size="md" weight="medium" lead="tight"
            ...
            <div class="col-span-12 sm:col-span-7">
              <div class="space-y-2">
                <DemoFlexTableRow v-for="(item, index) in items" :key="index" rounded="sm">
                  <template #start>
                    <DemoFlexTableStart label="type" :hide-label="index > 0" :title="item.title"
                      :subtitle="item.subtitle" :icon="item.icon" />
                  </template>
                  <template #end>
                    <DemoFlexTableCell label="count" :hide-label="index > 0" class="w-full sm:w-10">
                      <span class="text-muted-500 dark:text-muted-400 font-sans text-sm">
                        {{ item.count }}
                      </span>
                    </DemoFlexTableCell>
                    <DemoFlexTableCell label="status" :hide-label="index > 0" class="w-full sm:w-16">
