            ...
            <div class="flex h-full flex-col justify-between gap-y-6 sm:flex-row sm:gap-y-0">
              <div class="flex flex-col">
                ...
                <div class="mt-auto flex flex-col items-center gap-2 sm:flex-row">
                  <BaseButton to="/layouts/send" rounded="md" variant="primary" class="w-full sm:w-auto">
                    Transfer Money
                  </BaseButton>
                  <BaseButton to="/layouts/accounts/linked" rounded="md" class="w-full sm:w-auto">
                    Link Accounts
                  </BaseButton>
                </div>
              </div>
            ...
            <div class="flex flex-col justify-between gap-y-16 sm:flex-row sm:gap-y-0">
              <div class="flex flex-col">
                ...
                <div class="mt-auto flex items-center gap-2">
                  <BaseButton to="/layouts/send" rounded="md">
                    Manage Orders
                  </BaseButton>
                </div>
              </div>
