      ...
      >
        ...
        <div class="nui-slimscroll overflow-y-auto px-4 pb-4 md:px-6 md:pb-6">
          <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 flex flex-col gap-4 sm:col-span-">
              <DialogDescription>
              ...
              <div class="space-y-1">
                ...
                <div>
                  <button type="button" class="group flex w-full items-center gap-3 rounded-lg p-2">
                    <span class="bg-muted-200 dark:bg-muted-900 block size-6 rounded-lg" />
                    <BaseText size="sm">
                      Background shade
                    </BaseText>
                  </button>
